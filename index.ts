/**
 * DI Rally - Design Pattern Demonstration
 * 
 ...
 * These patterns aren't just academic exercises or overengineering. They solve
...
async function runRepRallyDemo() {
  ...
  container.register(SERVICE_IDENTIFIERS.TRANSACTION_MANAGER, {
    useFactory: (container) => {
      ...
      // This is the "withX" pattern - a fluent interface for the Builder Pattern
  ...
  console.log("• Extensibility: New features can be added without breaking existing code");
  console.log("• Scalability: The system can grow in complexity without becoming unmanageable");
  ...
  console.log("\nFOR JUNIOR DEVELOPERS:");
  console.log("These patterns might seem complex at first, but they solve real problems");
  console.log("that you'll encounter as applications grow. Learning these patterns will");
  console.log("make you a more effective developer and help you build better software!");
}
